...
public class RecipesDyes
{
    ...
    public void addRecipes(CraftingManager par1CraftingManager)
    {
        ...
        for (i = 0; i < 16; ++i)
        {
            par1CraftingManager.addShapelessRecipe(new ItemStack(Blocks.wool, 1, BlockColored.func_150031_c(i)), new Object[] {new ItemStack(Items.dye, 1, i), new ItemStack(Item.getItemFromBlock(Blocks.wool), 1, 0)});
