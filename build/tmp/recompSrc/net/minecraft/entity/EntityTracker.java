...
public class EntityTracker
{
    ...
    public void addEntityToTracker(Entity par1Entity, int par2, final int par3, boolean par4)
    {
        ...
        try
        {
            ...
            this.trackedEntityIDs.addKey(par1Entity.getEntityId(), entitytrackerentry);
        ...
        catch (Throwable throwable)
        {
            ...
            ((EntityTrackerEntry)this.trackedEntityIDs.lookup(par1Entity.getEntityId())).myEntity.addEntityCrashInfo(crashreportcategory1);
    ...
    public void removeEntityFromAllTrackingPlayers(Entity par1Entity)
    {
        ...
        EntityTrackerEntry entitytrackerentry1 = (EntityTrackerEntry)this.trackedEntityIDs.removeObject(par1Entity.getEntityId());
