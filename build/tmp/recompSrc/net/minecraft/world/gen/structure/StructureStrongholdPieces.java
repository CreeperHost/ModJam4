    ...
    public static class ChestCorridor extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                else
                {
                    ...
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 3, 1, 2, 3, 1, 4, Blocks.stonebrick, Blocks.stonebrick, false);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 5, 3, 1, 1, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 5, 3, 1, 5, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 5, 3, 2, 2, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 5, 3, 2, 4, par3StructureBoundingBox);
                    int i;

                    for (i = 2; i <= 4; ++i)
                    {
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 5, 2, 1, i, par3StructureBoundingBox);
                    }
    ...
    public static class Corridor extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                else
                {
                    ...
                    {
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 0, 0, i, par3StructureBoundingBox);
                        ...
                        for (int j = 1; j <= 3; ++j)
                        {
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 0, j, i, par3StructureBoundingBox);
    ...
    public static class Crossing extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                else
                {
                    ...
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 3, 4, 3, 3, 4, Blocks.stone_slab, Blocks.stone_slab, false);
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 4, 6, 3, 4, 6, Blocks.stone_slab, Blocks.stone_slab, false);
                    ...
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 5, 1, 9, 7, 1, 9, Blocks.stone_slab, Blocks.stone_slab, false);
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 5, 2, 7, 7, 2, 7, Blocks.stone_slab, Blocks.stone_slab, false);
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 5, 7, 4, 5, 9, Blocks.stone_slab, Blocks.stone_slab, false);
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 8, 5, 7, 8, 5, 9, Blocks.stone_slab, Blocks.stone_slab, false);
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 5, 5, 7, 7, 5, 9, Blocks.double_stone_slab, Blocks.double_stone_slab, false);
    ...
    public static class Library extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                else
                {
                    ...
                    this.randomlyFillWithBlocks(par1World, par3StructureBoundingBox, par2Random, 0.07F, 2, 1, 1, 11, 4, 13, Blocks.web, Blocks.web, false);
                    boolean flag = true;
                    boolean flag1 = true;
                    int i;
                    ...
                    for (i = 1; i <= 13; ++i)
                    {
                        if ((i - 1) % 4 == 0)
                        {
                            this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 1, i, 1, 4, i, Blocks.planks, Blocks.planks, false);
                            this.fillWithBlocks(par1World, par3StructureBoundingBox, 12, 1, i, 12, 4, i, Blocks.planks, Blocks.planks, false);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.torch, 0, 2, 3, i, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.torch, 0, 11, 3, i, par3StructureBoundingBox);

                            if (this.isLargeRoom)
                            {
                                this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 6, i, 1, 9, i, Blocks.planks, Blocks.planks, false);
                                this.fillWithBlocks(par1World, par3StructureBoundingBox, 12, 6, i, 12, 9, i, Blocks.planks, Blocks.planks, false);
                            }
                        }
                        else
                        {
                            this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 1, i, 1, 4, i, Blocks.bookshelf, Blocks.bookshelf, false);
                            this.fillWithBlocks(par1World, par3StructureBoundingBox, 12, 1, i, 12, 4, i, Blocks.bookshelf, Blocks.bookshelf, false);

                            if (this.isLargeRoom)
                            {
                                this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 6, i, 1, 9, i, Blocks.bookshelf, Blocks.bookshelf, false);
                                this.fillWithBlocks(par1World, par3StructureBoundingBox, 12, 6, i, 12, 9, i, Blocks.bookshelf, Blocks.bookshelf, false);
                            }
                        }
                    }
                    ...
                    for (i = 3; i < 12; i += 2)
                    {
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 3, 1, i, 4, 3, i, Blocks.bookshelf, Blocks.bookshelf, false);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 6, 1, i, 7, 3, i, Blocks.bookshelf, Blocks.bookshelf, false);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 9, 1, i, 10, 3, i, Blocks.bookshelf, Blocks.bookshelf, false);
                    }

                    if (this.isLargeRoom)
                    {
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 5, 1, 3, 5, 13, Blocks.planks, Blocks.planks, false);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 10, 5, 1, 12, 5, 13, Blocks.planks, Blocks.planks, false);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 5, 1, 9, 5, 2, Blocks.planks, Blocks.planks, false);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 5, 12, 9, 5, 13, Blocks.planks, Blocks.planks, false);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.planks, 0, 9, 5, 11, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.planks, 0, 8, 5, 11, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.planks, 0, 9, 5, 10, par3StructureBoundingBox);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 3, 6, 2, 3, 6, 12, Blocks.fence, Blocks.fence, false);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 10, 6, 2, 10, 6, 10, Blocks.fence, Blocks.fence, false);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 6, 2, 9, 6, 2, Blocks.fence, Blocks.fence, false);
                        this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 6, 12, 8, 6, 12, Blocks.fence, Blocks.fence, false);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, 9, 6, 11, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, 8, 6, 11, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, 9, 6, 10, par3StructureBoundingBox);
                        i = this.getMetadataWithOffset(Blocks.ladder, 3);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.ladder, i, 10, 1, 13, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.ladder, i, 10, 2, 13, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.ladder, i, 10, 3, 13, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.ladder, i, 10, 4, 13, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.ladder, i, 10, 5, 13, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.ladder, i, 10, 6, 13, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.ladder, i, 10, 7, 13, par3StructureBoundingBox);
                        byte b1 = 7;
                        byte b2 = 7;
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1 - 1, 9, b2, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1, 9, b2, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1 - 1, 8, b2, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1, 8, b2, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1 - 1, 7, b2, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1, 7, b2, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1 - 2, 7, b2, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1 + 1, 7, b2, par3StructureBoundingBox);
                        ...
                        this.placeBlockAtCurrentPosition(par1World, Blocks.fence, 0, b1, 7, b2 + 1, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.torch, 0, b1 - 2, 8, b2, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.torch, 0, b1 + 1, 8, b2, par3StructureBoundingBox);
    ...
    public static class PortalRoom extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 1, 1, 1, 1, 3, Blocks.flowing_lava, Blocks.flowing_lava, false);
                this.fillWithBlocks(par1World, par3StructureBoundingBox, 9, 1, 1, 9, 1, 3, Blocks.flowing_lava, Blocks.flowing_lava, false);
                ...
                this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 1, 9, 6, 1, 11, Blocks.flowing_lava, Blocks.flowing_lava, false);
                int i;

                for (i = 3; i < 14; i += 2)
                {
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 0, 3, i, 0, 4, i, Blocks.iron_bars, Blocks.iron_bars, false);
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 10, 3, i, 10, 4, i, Blocks.iron_bars, Blocks.iron_bars, false);
                }

                for (i = 2; i < 9; i += 2)
                {
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, i, 3, 15, i, 4, 15, Blocks.iron_bars, Blocks.iron_bars, false);
                }
                ...
                for (int j = 4; j <= 6; ++j)
                {
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_brick_stairs, i, j, 1, 4, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_brick_stairs, i, j, 2, 5, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_brick_stairs, i, j, 3, 6, par3StructureBoundingBox);
                }
                ...
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b4 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 4, 3, 8, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b4 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 5, 3, 8, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b4 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 6, 3, 8, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b1 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 4, 3, 12, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b1 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 5, 3, 12, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b1 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 6, 3, 12, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b2 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 3, 3, 9, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b2 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 3, 3, 10, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b2 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 3, 3, 11, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b3 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 7, 3, 9, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b3 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 7, 3, 10, par3StructureBoundingBox);
                this.placeBlockAtCurrentPosition(par1World, Blocks.end_portal_frame, b3 + (par2Random.nextFloat() > 0.9F ? 4 : 0), 7, 3, 11, par3StructureBoundingBox);
    ...
    public static class Prison extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                else
                {
                    ...
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 1, 4, 4, 3, 6, Blocks.iron_bars, Blocks.iron_bars, false);
                    this.fillWithBlocks(par1World, par3StructureBoundingBox, 5, 1, 5, 7, 3, 5, Blocks.iron_bars, Blocks.iron_bars, false);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.iron_bars, 0, 4, 3, 2, par3StructureBoundingBox);
    ...
    public static class RoomCrossing extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                else
                {
                    ...
                    {
                        case 0:
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 5, 1, 5, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 5, 2, 5, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 5, 3, 5, par3StructureBoundingBox);
                            ...
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 4, 1, 4, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 4, 1, 5, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 4, 1, 6, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 6, 1, 4, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 6, 1, 5, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 6, 1, 6, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 5, 1, 4, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 5, 1, 6, par3StructureBoundingBox);
                            break;
                        case 1:
                            for (i = 0; i < 5; ++i)
                            {
                                this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 3, 1, 3 + i, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 7, 1, 3 + i, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 3 + i, 1, 3, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 3 + i, 1, 7, par3StructureBoundingBox);
                            }
                        ...
                        case 2:
                            for (i = 1; i <= 9; ++i)
                            {
                                this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 1, 3, i, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 9, 3, i, par3StructureBoundingBox);
                            }

                            for (i = 1; i <= 9; ++i)
                            {
                                this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, i, 3, 1, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, i, 3, 9, par3StructureBoundingBox);
                            }

                            this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 5, 1, 4, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 5, 1, 6, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 5, 3, 4, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 5, 3, 6, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 4, 1, 5, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 6, 1, 5, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 4, 3, 5, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 6, 3, 5, par3StructureBoundingBox);

                            for (i = 1; i <= 3; ++i)
                            {
                                this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 4, i, 4, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 6, i, 4, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 4, i, 6, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.cobblestone, 0, 6, i, 6, par3StructureBoundingBox);
                            }
                            ...
                            for (i = 2; i <= 8; ++i)
                            {
                                this.placeBlockAtCurrentPosition(par1World, Blocks.planks, 0, 2, 3, i, par3StructureBoundingBox);
                                this.placeBlockAtCurrentPosition(par1World, Blocks.planks, 0, 3, 3, i, par3StructureBoundingBox);

                                if (i <= 3 || i >= 7)
                                {
                                    this.placeBlockAtCurrentPosition(par1World, Blocks.planks, 0, 4, 3, i, par3StructureBoundingBox);
                                ...
                                this.placeBlockAtCurrentPosition(par1World, Blocks.planks, 0, 7, 3, i, par3StructureBoundingBox);
    ...
    public static class Stairs extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                else
                {
                    ...
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 2, 6, 1, par3StructureBoundingBox);
                    ...
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 1, 4, 3, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 1, 5, 3, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 2, 4, 3, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 3, 3, 3, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 3, 4, 3, par3StructureBoundingBox);
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 3, 3, 2, par3StructureBoundingBox);
                    ...
                    this.placeBlockAtCurrentPosition(par1World, Blocks.stone_slab, 0, 1, 1, 3, par3StructureBoundingBox);
                    return true;
                }
            }
        }
    ...
    public static class StairsStraight extends StructureStrongholdPieces.Stronghold
        {
            ...
            public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
            {
                ...
                else
                {
                    ...
                    for (int j = 0; j < 6; ++j)
                    {
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stone_stairs, i, 1, 6 - j, 1 + j, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stone_stairs, i, 2, 6 - j, 1 + j, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stone_stairs, i, 3, 6 - j, 1 + j, par3StructureBoundingBox);

                        if (j < 5)
                        {
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 1, 5 - j, 1 + j, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 2, 5 - j, 1 + j, par3StructureBoundingBox);
                            this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, 3, 5 - j, 1 + j, par3StructureBoundingBox);
                        }
                    }
            ...
            protected void placeDoor(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox, StructureStrongholdPieces.Stronghold.Door par4EnumDoor, int par5, int par6, int par7)
            {
                switch (StructureStrongholdPieces.SwitchDoor.doorEnum[par4EnumDoor.ordinal()])
                {
                    ...
                    default:
                        ...
                        break;
                    case 2:
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5, par6, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5, par6 + 1, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5, par6 + 2, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5 + 1, par6 + 2, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5 + 2, par6 + 2, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5 + 2, par6 + 1, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5 + 2, par6, par7, par3StructureBoundingBox);
                    ...
                    case 3:
                        ...
                        this.placeBlockAtCurrentPosition(par1World, Blocks.iron_bars, 0, par5, par6, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.iron_bars, 0, par5, par6 + 1, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.iron_bars, 0, par5, par6 + 2, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.iron_bars, 0, par5 + 1, par6 + 2, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.iron_bars, 0, par5 + 2, par6 + 2, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.iron_bars, 0, par5 + 2, par6 + 1, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.iron_bars, 0, par5 + 2, par6, par7, par3StructureBoundingBox);
                        break;
                    case 4:
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5, par6, par7, par3StructureBoundingBox);
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stonebrick, 0, par5, par6 + 1, par7, par3StructureBoundingBox);
                        ...
                        this.placeBlockAtCurrentPosition(par1World, Blocks.stone_button, this.getMetadataWithOffset(Blocks.stone_button, 4), par5 + 2, par6 + 1, par7 + 1, par3StructureBoundingBox);
