                ...
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (j1 = 0; j1 < 8; ++j1)
                    {
                        ...
                        if (flag)
                        {
                            ...
                            if (j1 < 4 && !material.isSolid() && par1World.getBlock(par3 + i1, par4 + j1, par5 + j2) != this.field_150556_a)
                            {
                                return false;
                            }
                        }
            ...
            for (i1 = 0; i1 < 16; ++i1)
            {
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (j1 = 0; j1 < 8; ++j1)
                    {
                        ...
                        {
                            par1World.setBlock(par3 + i1, par4 + j1, par5 + j2, j1 >= 4 ? Blocks.air : this.field_150556_a, 0, 2);
                        }
                    }
                }
            }
                ...
                for (j2 = 0; j2 < 16; ++j2)
                {
                    for (j1 = 4; j1 < 8; ++j1)
                    {
                        if (aboolean[(i1 * 16 + j2) * 8 + j1] && par1World.getBlock(par3 + i1, par4 + j1 - 1, par5 + j2) == Blocks.dirt && par1World.getSavedLightValue(EnumSkyBlock.Sky, par3 + i1, par4 + j1, par5 + j2) > 0)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + i1, par4 + j1 - 1, par5 + j2, Blocks.mycelium, 0, 2);
                            }
                            else
                            {
                                par1World.setBlock(par3 + i1, par4 + j1 - 1, par5 + j2, Blocks.grass, 0, 2);
                            }
                        }
                    }
                }
                ...
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
                    {
                        for (j1 = 0; j1 < 8; ++j1)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + i1, par4 + j1, par5 + j2, Blocks.stone, 0, 2);
                            }
                        }
                    }
                }
