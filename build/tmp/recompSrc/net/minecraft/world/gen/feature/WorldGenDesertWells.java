    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            for (l = -2; l <= 2; ++l)
            {
                for (i1 = -2; i1 <= 2; ++i1)
                {
                    if (par1World.isAirBlock(par3 + l, par4 - 1, par5 + i1) && par1World.isAirBlock(par3 + l, par4 - 2, par5 + i1))
                    {
                        return false;
                    }
                }
            ...
            for (l = -1; l <= 0; ++l)
            {
                for (i1 = -2; i1 <= 2; ++i1)
                {
                    ...
                    {
                        par1World.setBlock(par3 + i1, par4 + l, par5 + j1, Blocks.sandstone, 0, 2);
                    }
                }
            }
            ...
            for (l = -2; l <= 2; ++l)
            {
                for (i1 = -2; i1 <= 2; ++i1)
                {
                    ...
                    {
                        par1World.setBlock(par3 + l, par4 + 1, par5 + i1, Blocks.sandstone, 0, 2);
                    }
                }
            }
            ...
            for (l = -1; l <= 1; ++l)
            {
                for (i1 = -1; i1 <= 1; ++i1)
                {
                    if (l == 0 && i1 == 0)
                    {
                        par1World.setBlock(par3 + l, par4 + 4, par5 + i1, Blocks.sandstone, 0, 2);
                    }
                    else
                    {
                        par1World.setBlock(par3 + l, par4 + 4, par5 + i1, Blocks.stone_slab, 1, 2);
                    }
                }
            }
            ...
            for (l = 1; l <= 3; ++l)
            {
                par1World.setBlock(par3 - 1, par4 + l, par5 - 1, Blocks.sandstone, 0, 2);
                par1World.setBlock(par3 - 1, par4 + l, par5 + 1, Blocks.sandstone, 0, 2);
                par1World.setBlock(par3 + 1, par4 + l, par5 - 1, Blocks.sandstone, 0, 2);
                par1World.setBlock(par3 + 1, par4 + l, par5 + 1, Blocks.sandstone, 0, 2);
            }
