...
public class WorldGenTallGrass extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        for (int l = 0; l < 128; ++l)
        {
            ...
            if (par1World.isAirBlock(i1, j1, k1) && this.field_150522_a.canBlockStay(par1World, i1, j1, k1))
            {
                par1World.setBlock(i1, j1, k1, this.field_150522_a, this.tallGrassMetadata, 2);
            }
        }
