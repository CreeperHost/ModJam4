...
public class CommandBanIp extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length >= 1 && par2ArrayOfStr[0].length() > 1)
        {
            ...
            if (matcher.matches())
            {
                this.func_147210_a(par1ICommandSender, par2ArrayOfStr[0], ichatcomponent == null ? null : ichatcomponent.getUnformattedText());
            }
            else
            {
                ...
                this.func_147210_a(par1ICommandSender, entityplayermp.getPlayerIP(), ichatcomponent == null ? null : ichatcomponent.getUnformattedText());
            }
        }
        else
        {
