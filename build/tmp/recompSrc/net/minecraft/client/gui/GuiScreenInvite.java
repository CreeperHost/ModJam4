    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        if (p_146284_1_.enabled)
        {
            ...
            else if (p_146284_1_.id == 0)
            {
                ...
                try
                {
                    McoServer mcoserver = mcoclient.func_148697_b(this.field_146923_g.field_148812_a, this.field_146921_f.getText());
                ...
                {
                    logger.error("Couldn\'t parse response inviting user", ioexception);
                    this.func_146920_a(this.field_146925_t);
                }
            }
        }
