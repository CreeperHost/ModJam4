...
public class GuiScreenOnlineServersSubscreen
{
    ...
    private void func_148396_b()
    {
        ...
        this.field_148401_d = new String[][] {{I18n.format("selectWorld.gameMode.survival.line1", new Object[0]), I18n.format("selectWorld.gameMode.survival.line2", new Object[0])}, {I18n.format("selectWorld.gameMode.creative.line1", new Object[0]), I18n.format("selectWorld.gameMode.creative.line2", new Object[0])}, {I18n.format("selectWorld.gameMode.adventure.line1", new Object[0]), I18n.format("selectWorld.gameMode.adventure.line2", new Object[0])}};
    }

    private String func_148398_c()
    {
        String s = I18n.format("options.difficulty", new Object[0]);
        return s + ": " + this.field_148403_b[this.field_148402_e];
    }

    private String func_148393_d()
    {
        String s = I18n.format("selectWorld.gameMode", new Object[0]);
        return s + ": " + this.field_148404_c[this.field_148399_f];
    }

    void func_148397_a(GuiButton p_148397_1_)
    {
        if (p_148397_1_.enabled)
        {
            if (p_148397_1_.id == 5005)
            {
                this.field_148402_e = (this.field_148402_e + 1) % this.field_148403_b.length;
                p_148397_1_.displayString = this.func_148398_c();
            }
            else if (p_148397_1_.id == 5006)
            {
                this.field_148399_f = (this.field_148399_f + 1) % this.field_148404_c.length;
                p_148397_1_.displayString = this.func_148393_d();
            }
        }
    }
