...
public class GuiScreenCreateOnlineWorld extends ScreenWithCallback
{
    ...
    private void func_146757_h()
    {
        ...
        {
            GuiScreenCreateOnlineWorld.TaskWorldCreation taskworldcreation = new GuiScreenCreateOnlineWorld.TaskWorldCreation(this.field_146760_g.getText(), this.field_146759_v);
            GuiScreenLongRunningTask guiscreenlongrunningtask = new GuiScreenLongRunningTask(this.mc, this.field_146758_f, taskworldcreation);
    ...
    class TaskWorldCreation extends TaskLongRunning
    {
        ...
        public void run()
        {
            String s = I18n.format("mco.create.world.wait", new Object[0]);
