...
public class GuiScreenEditOnlineWorld extends GuiScreen
{
    ...
    private void func_146853_g()
    {
        ...
        try
        {
            String s = this.field_146863_h.getText() != null && !this.field_146863_h.getText().trim().equals("") ? this.field_146863_h.getText() : null;
            mcoclient.func_148689_a(this.field_146861_r.field_148812_a, this.field_146864_i.getText(), s, this.field_146854_w.field_148402_e, this.field_146854_w.field_148399_f);
