        ...
        for (int j = 0; j < 10 && !this.func_148418_c(); ++j)
        {
            ...
            catch (ExceptionMcoService exceptionmcoservice)
            {
                ...
                else
                {
                    ...
                    logger.error("Couldn\'t connect to world", exceptionmcoservice);
                }
            ...
            {
                logger.error("Couldn\'t parse response connecting to world", ioexception);
            }
        ...
        (new Thread("MCO Connector #" + field_148439_a.incrementAndGet())
        {
            ...
            public void run()
            {
                ...
                catch (UnknownHostException unknownhostexception)
                {
                    ...
                    TaskOnlineConnect.logger.error("Couldn\'t connect to world", unknownhostexception);
                ...
                catch (Exception exception)
                {
                    ...
                    TaskOnlineConnect.logger.error("Couldn\'t connect to world", exception);
                    TaskOnlineConnect.this.func_148413_b().displayGuiScreen(new GuiScreenDisconnectedOnline(TaskOnlineConnect.this.field_148435_f, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {exception.toString()})));
                }
            }
        }).start();
    }
