...
public class McoServerList
{
    ...
    class UpdateTask extends TimerTask
    {
        ...
        private void func_148494_a()
        {
            ...
            {
                McoServerList.logger.error("Couldn\'t get server list", exceptionmcoservice);
            }
        ...
        private void func_148495_b()
        {
            ...
            {
                McoServerList.logger.error("Couldn\'t get pending invite count", exceptionmcoservice);
            }
        }
        ...
        private void func_148496_c()
        {
            ...
            {
                McoServerList.logger.error("Couldn\'t get token count", exceptionmcoservice);
